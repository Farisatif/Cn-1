        ...
        <section className="grid grid-cols-1 xl:grid-cols-3 gap-8 lg:gap-12 items-start mb-12 sm:mb-16">
          <div className="xl:col-span-2 space-y-6 sm:space-y-8">
            ...
            <div className="space-y-4">
              <div className="flex flex-col gap-3">
                <div className="relative">
                  ...
                  <Input
                    ...
                    onKeyDown={(e) => {
                      if (e.key === "Enter") {
                        navigate(`/career-bank?search=${encodeURIComponent(searchQuery)}`)
                      }
                    }}
                  />
                </div>
                <Button
                  ...
                  onClick={() => navigate(`/career-bank?search=${encodeURIComponent(searchQuery)}`)}
                >
                  Search Careers
                </Button>
              </div>
              ...
              <div className="flex gap-2 overflow-x-auto pb-2 scrollbar-hide">
                <Badge
                  ...
                  onClick={() => navigate("/career-bank?industry=Technology&trending=ai")}
                >
                ...
                <Badge
                  variant="outline"
                  className="hover:bg-primary/10 cursor-pointer whitespace-nowrap"
                  onClick={() => navigate("/resources?category=remote-work")}
                >
                  Remote Work Guide
                </Badge>
                <Badge
                  variant="outline"
                  className="hover:bg-primary/10 cursor-pointer whitespace-nowrap"
                  onClick={() => navigate("/resources?category=tech-skills")}
                >
                  Tech Skills 2024
                </Badge>
                <Badge
                  variant="outline"
                  className="hover:bg-primary/10 cursor-pointer whitespace-nowrap"
                  onClick={() => navigate("/career-bank?industry=Environment")}
                >
                  Green Jobs Rising
                </Badge>
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              <Link to="/career-bank?industry=Technology" className="group">
              ...
              <Link to="/multimedia" className="group sm:col-span-2 lg:col-span-1">
                <Card className="h-full card-hover border-border bg-card/50 backdrop-blur-sm">
                  <CardContent className="p-4 sm:p-6">
                    <div className="flex items-center gap-3 mb-3 sm:mb-4">
                      <div className="p-2 sm:p-3 rounded-xl bg-primary/10 group-hover:bg-primary/20 transition-colors">
        ...
        <section className="mb-12 sm:mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {[
              {
                name: "Sara Ahmed",
                story: "Landed her dream AI job within 3 months of using NextStep Navigator.",
                href: "/stories?featured=sara-ahmed",
              },
              {
                name: "Ali Hassan",
                story:
                  "Successfully transitioned from teaching to software development with guidance from our career tools.",
                href: "/stories?featured=ali-hassan",
              },
              {
                name: "Lina Khalid",
                story: "Upskilled in data science and secured a promotion within 6 months.",
                href: "/stories?featured=lina-khalid",
              },
            ].map((person, idx) => (
              <Card
                key={idx}
                className="card-hover border-border bg-card/50 backdrop-blur-sm cursor-pointer"
