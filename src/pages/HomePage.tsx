...
/**
 * HomePage (Next.js - client)
 * - replaces react-router with next/navigation + next/link
 * - fixes navigate -> router.push
 * - adds intro splash that shows on first visit (stored in localStorage)
 * - stores recent search terms locally
 * - prefetch hint on clickable cards
 *
 * Paste in a client component file (e.g. app/page.tsx or components/HomePage.tsx)
 */
...
export default function HomePage() {
  ...
  const getPersonalizedRecommendations = () => {
    const recommendations = {
      student: [
        { title: "Explore STEM Careers", icon: <Target className="h-5 w-5" />, path: "/career-bank?industry=Technology" },
  ...
  // small prefetch helper (best-effort)
  const tryPrefetch = (href?: string) => {
    if (!href) return
    try {
      // @ts-ignore - router.prefetch may exist
          ...
          <div className="max-w-xl w-full rounded-xl bg-popover p-6 border border-border shadow-2xl text-center">
            ...
            <div className="mb-4">
              ...
              <p className="text-sm text-muted-foreground max-w-md mx-auto">
                Discover curated career paths, personalized quizzes and resources tailored to your profile. This
                quick tour helps you get started.
              </p>
            </div>
            ...
            <div className="flex gap-3 justify-center mt-4">
              <Button
                ...
                onClick={() => {
                  dismissIntro(true)
                  // optionally navigate to quick tour or highlight features
                  router.push("/tour")
                }}
              >
                Take a quick tour
            ...
            <div className="xl:col-span-2 space-y-6 sm:space-y-8">
              ...
              <div className="space-y-4">
                  ...
                  <div className="flex gap-3 items-center">
                    ...
                    <div className="hidden sm:flex gap-2 text-xs">
                      <Badge
                        ...
                        onClick={() => {
                          tryPrefetch("/career-bank?industry=Technology&trending=ai")
                          router.push("/career-bank?industry=Technology&trending=ai")
                        }}
                      >
                      ...
                      <Badge
                        ...
                        className="hover:bg-primary/10 cursor-pointer whitespace-nowrap"
                        onClick={() => {
                          tryPrefetch("/resources?category=remote-work")
                          router.push("/resources?category=remote-work")
                        }}
                      >
                        Remote Work Guide
                      </Badge>
                      ...
                      <Badge
                        ...
                        className="hover:bg-primary/10 cursor-pointer whitespace-nowrap"
                        onClick={() => {
                          tryPrefetch("/resources?category=tech-skills")
                          router.push("/resources?category=tech-skills")
                        }}
                      >
                        Tech Skills 2024
                      </Badge>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                  <Link
                    href="/career-bank?industry=Technology"
                    onMouseEnter={() => tryPrefetch("/career-bank?industry=Technology")}
                    className="group"
                  >
                  ...
                  <Link href="/admission" onMouseEnter={() => tryPrefetch("/admission")} className="group">
                    <Card className="h-full card-hover border-border bg-card/50 backdrop-blur-sm">
                      <CardContent className="p-4 sm:p-6">
                        <div className="flex items-center gap-3 mb-3 sm:mb-4">
                          <div className="p-2 sm:p-3 rounded-xl bg-primary/10 group-hover:bg-primary/20 transition-colors">
                  ...
                  <Link href="/multimedia" onMouseEnter={() => tryPrefetch("/multimedia")} className="group sm:col-span-2 lg:col-span-1">
                    <Card className="h-full card-hover border-border bg-card/50 backdrop-blur-sm">
                      <CardContent className="p-4 sm:p-6">
                        <div className="flex items-center gap-3 mb-3 sm:mb-4">
                          <div className="p-2 sm:p-3 rounded-xl bg-primary/10 group-hover:bg-primary/20 transition-colors">
            ...
            <section className="mb-12 sm:mb-16 animate-fade-in-up">
              <Card className="border-border bg-card/50 backdrop-blur-sm">
                <CardHeader className="text-center sm:text-left">
                  ...
                  <CardDescription className="text-sm sm:text-base">Personalized suggestions based on your profile</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                    {recommendations.map((rec, idx) => (
                      ...
                      >
                        <CardContent className="p-4 sm:p-6 text-center">
                          ...
                          <Button variant="ghost" size="sm" className="text-primary hover:text-primary/80 text-sm" onClick={() => router.push(rec.path)}>
                ...
                >
                  <CardContent className="p-4 sm:p-6">
                    <div className="flex items-center gap-3 mb-3 sm:mb-4">
                      ...
                      <Badge variant={idx === 0 ? "secondary" : "outline"} className={`text-xs ${idx === 0 ? "bg-accent/10 text-accent" : ""}`}>
                        {item.badge}
                      </Badge>
                    </div>
          ...
          <section className="mb-12 sm:mb-16">
            <Card className="text-center py-12 sm:py-16 px-6 sm:px-8 bg-gradient-to-br from-primary/5 via-accent/5 to-primary/5 border-primary/20">
              <CardContent className="max-w-3xl mx-auto space-y-4 sm:space-y-6">
                ...
                <Button onClick={handleGetStarted} size="lg" className="h-12 sm:h-14 px-6 sm:px-8 text-base sm:text-lg font-semibold bg-primary hover:bg-primary/90 w-full sm:w-auto">
